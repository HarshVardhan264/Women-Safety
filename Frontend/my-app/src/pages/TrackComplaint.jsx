  ...
  return (
    <div className="min-h-screen bg-[#FEF7F2] text-slate-900">
      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        {loading ? (
          <div className="mt-10 rounded-[32px] bg-white border border-slate-200 p-16 shadow-xl">
            <div className="flex flex-col items-center justify-center gap-5">
              <div className="h-14 w-14 animate-spin rounded-full border-4 border-slate-300 border-t-violet-600"></div>
              ...
              <p className="text-slate-500">
                Please wait while we retrieve your complaint details.
              </p>
            </div>
          </div>
        ) : (
